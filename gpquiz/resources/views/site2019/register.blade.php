                  ...
                  <div class="col-md-6 col-md-offset-3 text-center texto-ligue">
                      <div class="col-md-12 no-padding-mobile">
                          <p>Enquanto os motores aquecem, por favor, <b>preencha</b> <br>
                             <b>o formulário</b> para iniciar o quiz.</p>
                      </div>
                  </div>
                  <form method="POST" action="/gp2019/cadastro" id="form-enviar">
                      {{ csrf_field() }}
...
<small style="position: relative;
    ...
    text-align: left;
    width: 100%;
    float: left;">*Caso não tenha e-mail corporativo, inserir seu e-mail pessoal.</small>
                          </div>

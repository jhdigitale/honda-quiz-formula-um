            ...
            <form method="POST" action="/admin/users/{{ $user->id }}">
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <input class="form-control" id="name" name="name" type="text" aria-describedby="name" placeholder="Digite seu nome" value="{{ $user->name }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="email" name="email" type="email" aria-describedby="emailHelp" placeholder="Digite seu email" value="{{ $user->email }}">
                </div>
